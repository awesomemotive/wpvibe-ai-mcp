<?php
namespace WPVibe\Vendor\enshrined\svgSanitize;

if ( ! defined( 'ABSPATH' ) ) {
    exit;
}

use WPVibe\Vendor\enshrined\svgSanitize\data\AllowedAttributes;
use WPVibe\Vendor\enshrined\svgSanitize\data\AllowedTags;
use WPVibe\Vendor\enshrined\svgSanitize\data\AttributeInterface;
use WPVibe\Vendor\enshrined\svgSanitize\data\TagInterface;
use WPVibe\Vendor\enshrined\svgSanitize\data\XPath;
use WPVibe\Vendor\enshrined\svgSanitize\ElementReference\Resolver;

/**
 * Class Sanitizer
 *
 * @package WPVibe\Vendor\enshrined\svgSanitize
 */
class Sanitizer
{
